...
// Same unsigned-preset Cloudinary flow as useBusinessImageUpload/
// useEventImageUpload — its own small hook since folder prefixes differ
// per module (crisisImages/ vs businessImages/ vs eventImages/).
...
export function useCrisisImageUpload(folderSuffix) {
  ...
  const uploadImage = useCallback(
    (uid) => {
      ...
      if (uid) {
        formData.append("folder", `crisisImages/${uid}${folderSuffix ? `/${folderSuffix}` : ""}`);
      }
